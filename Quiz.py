...
Ans = st.text_input("Enter your ans__","Ans 1_")
...
Ans = st.text_input("Enter your ans__","Ans 2_")
if Ans.lower() == "C".lower():
    Score += 5
...
Ans = st.text_input("Enter your ans__","Ans 3_")
...
Ans = st.text_input("Enter your ans__","Ans 4_")
if Ans.lower() == "C".lower():
    Score += 5
...
Ans = st.text_input("Enter your ans__","Ans 5_")
if Ans.lower() == "B".lower():
    Score += 5
...
Ans = st.text_input("Enter your ans__","Ans 16_")
if Ans.lower() == "C".lower():
    Score += 5
st.write("---------------------------------------------------------------------------------------------")
